...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=18&pause=1200&color=38BDF8&center=true&vCenter=true&width=580&lines=Building+end-to-end+ML+pipelines+%F0%9F%A4%96;Statistical+modeling+%26+data+storytelling+%F0%9F%93%8A;NLP+%7C+Time+Series+%7C+Supervised+Learning;Teaching+Assistant+%40+SDU+University+%F0%9F%8E%93;Open+to+internships+%26+research+collaborations" alt="Typing SVG" />
</a>
...
**Methods:** Linear/Logistic Regression · Random Forest · Gradient Boosting · ARIMA · Holt-Winters · SVM · Naive Bayes · K-Means · PCA · TF-IDF · Hypothesis Testing · ANOVA
...
|---|---|---|
| 🎓 **Student Performance Prediction** | Python · Scikit-learn · Power BI | 84% accuracy · SHAP interpretability · SMOTE for class imbalance |
| 🛒 **E-commerce Sales Analytics** | SQL · Power BI · Excel | 50K+ records · Cohort analysis · YoY comparison · 17% seasonal spike found |
| 🗣️ **Kazakh-Russian Sentiment Classifier** | Python · NLTK · SVM | 2,000 labeled reviews · Multilingual NLP · F1 = 0.81 |
| 🌡️ **Almaty Weather Forecasting** | Python · Statsmodels | ARIMA + Holt-Winters · 5 years data · 30-day forecast · Top grade |
| 🏠 **Almaty Housing Market EDA** | Python · Pandas · Seaborn | Web scraped data · Linear regression · 15-page report |
...
```
📚  Hypothesis Testing & Modern Regression Analysis 2 (Semester 6)
🤖  Introduction to Machine Learning — university course
🔬  Supporting PhD supervisor's research with real data tasks
📖  Self-studying: Deep Learning fundamentals, NLP with Transformers
🎓  Teaching & tutoring at Azat Academia — making DS accessible
